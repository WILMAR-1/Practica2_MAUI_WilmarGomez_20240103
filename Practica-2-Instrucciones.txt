...
Esta práctica profundiza en la arquitectura interna de .NET MAUI. Explorarás los
archivos clave del proyecto, modificarás recursos, implementarás eventos del ciclo
de vida y crearás navegación entre páginas.
...
Crea un documento Word o PDF y agrega una sección llamada "Estructura del
Proyecto"
...
Documenta lo siguiente:
   ...
   1. Archivos principales en la raíz:
          ...
          o   ¿Qué hace MauiProgram.cs?

          o   ¿Qué hace App.xaml?

          o   ¿Qué hace App.xaml.cs?

          o   ¿Qué hace MainPage.xaml?

   2. Carpeta Resources:

          o   Lista las subcarpetas que contiene

          o   ¿Qué tipo de archivos va en cada subcarpeta?

   3. Carpeta Platforms:

          o   Lista las carpetas de plataformas que ves

          o   ¿Para qué sirve cada una?

CAPTURA DE PANTALLA 1: Solution Explorer mostrando toda la estructura del
proyecto expandida
...
2.1 Modificar colores de la aplicación
   ...
   3. Modifica los siguientes colores a tu preferencia:
          ...
          o   Primary: Cambia a tu color favorito (ejemplo: #FF6B35 para naranja)

          o   Secondary: Cambia a un color complementario

          o   Background: Mantén un color claro o el que prefieras
...
{
  ...
  System.Diagnostics.Debug.WriteLine("App OnSleep - Aplicación en segundo
plano");
...
CAPTURA DE PANTALLA 3: Archivo App.xaml.cs mostrando los métodos del ciclo de
vida implementados

CAPTURA DE PANTALLA 4: Ventana Output mostrando los mensajes de
Debug.WriteLine
...
   1. ¿Qué es MauiApp.CreateBuilder()?
          ...
          o   Respuesta esperada: Crea un constructor que permite configurar la
              aplicación MAUI

   2. ¿Para qué sirve .UseMauiApp<App>()?

          o   Respuesta esperada: Especifica la clase App como punto de entrada de
              la aplicación

   3. ¿Qué hace .ConfigureFonts()?

          o   Respuesta esperada: Registra las fuentes que la aplicación puede usar

   4. ¿Por qué es importante builder.Build()?

          o   Respuesta esperada: Construye y retorna la aplicación configurada,
...
Criterio                   Puntos Descripción
                                   ...
                                   Documentación completa de la estructura del
Exploración de estructura 0.5
                                   proyecto

                                   Colores modificados correctamente en
Modificación de recursos 0.5
                                   Colors.xaml

                                   Métodos implementados y funcionando
Ciclo de vida              0.5
                                   (evidencia en Output)

                                   Segunda página creada y navegación
Navegación entre páginas 0.75
                                   funcionando

Análisis de
                           0.25    Respuestas correctas a las preguntas
MauiProgram.cs

TOTAL BASE                 2.5

BONUS: Fuente
                           +0.25   Fuente agregada y registrada correctamente
personalizada

BONUS: Código
                           +0.25   Análisis de archivos específicos de plataforma
específico
...
Exploración de estructura (0.5 puntos)
   ...
   •       Excelente (0.5): Documentación completa y correcta de todos los archivos
       y carpetas
...
Modificación de recursos (0.5 puntos)
   ...
   •      Excelente (0.5): Colores modificados, captura clara, app ejecuta con
       nuevos colores

   •     Regular (0.25): Colores modificados pero captura poco clara o errores
       menores
...
Ciclo de vida (0.5 puntos)
   ...
   •      Excelente (0.5): Métodos implementados correctamente, captura de
       Output muestra mensajes
...
Navegación entre páginas (0.75 puntos)
   ...
   •       Excelente (0.75): Navegación funciona en ambas direcciones, capturas
       claras
...
P: ¿Puedo usar el proyecto de la Práctica 1? R: Sí, es recomendado. Esta práctica
continúa sobre ese proyecto.

P: No encuentro la carpeta Platforms/ R: Asegúrate de hacer clic en "Show All Files"
en el Solution Explorer.

P: Los mensajes de Debug.WriteLine no aparecen R: Verifica que la ventana Output
esté configurada en "Debug" y que estés ejecutando en modo Debug (no Release).

P: El NavigationPage me da error R: Asegúrate de usar new NavigationPage(new
MainPage()) en App.xaml.cs.

P: ¿Puedo cambiar otros recursos además de colores? R: Sí, puedes experimentar
con estilos en Resources/Styles/Styles.xaml, pero no es obligatorio.
...
RECURSOS ADICIONALES
   ...
   •   https://learn.microsoft.com/dotnet/maui/fundamentals/app-lifecycle
...
Nota importante: Esta práctica es individual. Puedes ayudar a tus compañeros a
resolver problemas técnicos, pero cada estudiante debe realizar su propia
implementación y entregar sus propias capturas de pantalla.



¡Éxito en tu segunda práctica de .NET MAUI!

Esta práctica te ayudará a comprender profundamente cómo funciona .NET MAUI
internamente, lo cual es fundamental para el resto del curso.
